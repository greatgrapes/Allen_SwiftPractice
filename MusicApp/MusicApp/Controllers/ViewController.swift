...
//    let searchController = UISearchController()
    ...
    let searchController = UISearchController(searchResultsController: UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "SearchResultController") as! SearchResultController)
...
extension ViewController: UISearchResultsUpdating {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        let vc = searchController.searchResultsController as! SearchResultController
        // 컬렉션뷰에 찾으려는 단어 전달
